...
_MODULE_NAME = "fontutils"
_PACKAGE_NAME = 'dghs-fontutils'
...
setup(
    ...
    keywords='font-processing, computer-vision, deep-learning, data-augmentation',
    url='https://github.com/deepghs/fontutils',
